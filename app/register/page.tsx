  ...
  const handleFinalSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (err instanceof AuthError) {
        switch (err.status) {
          case 400:
            setError("Onjuiste of onvolledige gegevens.");
            break;
          case 409:
            setError(
              "Dit e-mailadres is al in gebruik. Log in of gebruik een ander e-mailadres om door te gaan."
            );
            break;
          case 500:
          ...
          <form className="login-form" onSubmit={handleFinalSubmit}>
            <div className="form-group">
              ...
              <p className="profile-description">
                ...
                Bijvoorbeeld: welke onderwerpen spreken je aan, wat zijn je
                doelen, en welke richting wil je op met je studie?
              </p>
              <textarea
                id="student-profile"
